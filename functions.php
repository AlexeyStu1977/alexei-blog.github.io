...
$options = array (
                array(  "name" => "Header Ad 460x60",
                        "desc" => "This is for the 460x60 Google AdSense banner in the header.<br /><br />",
                        "id" => "fsh_banner",
                        "std" => "(Input html or adsense code here)",
                        "type" => "textarea"),
		array(  "name" => "Sidebar Ad 200x200",
                        "desc" => "This is for the 200x200 Google AdSense banner in the 2nd sidebar.<br /><br />",
                        "id" => "fsh_adsense_200",
                        "std" => "(Input html or adsense code here)",
                        "type" => "textarea"),
                array(  "name" => "Footer",
...
function art_add_admin() {
    ...
    add_theme_page("Fishing Theme Three Options", "Fishing Theme Three Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Fishing Theme Three Options</h2>
